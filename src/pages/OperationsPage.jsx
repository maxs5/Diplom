...
export function OperationsPage() {
  ...
  const { deleteOperation, getFilteredOperations, loading: operationsLoading } = useOperations();
    ...
    <div className="operations-page">
      <div className="operations-header">
        ...
        <div style={{ display: 'flex', gap: '8px' }}>
          <Button onClick={() => {
            const csv = exportOperationsToCSV(filteredOperations.map(op => ({
              ...op,
              accountName: accounts.find(a => a.id === op.accountId)?.name || '',
              categoryName: categories.find(c => c.id === op.categoryId)?.name || '',
            })));
            downloadCSV(csv, `операции-${new Date().toISOString().split('T')[0]}.csv`);
                  ...
                  <div key={operation.id} className="operation-item">
                    ...
                    <div className="operation-main">
                      ...
                      <div className="operation-info">
                        <div className="operation-category">{details.category}</div>
